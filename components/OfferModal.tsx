...
export default function OfferModal({
  ...
  // FIX: Reset traveler count to 1 whenever the modal opens or the offer changes
  useEffect(() => {
    if (isOpen) {
      setTravelers(1);
    }
      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto bg-white rounded-xl">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center space-x-4 text-sm text-gray-600 bg-gray-50 p-3 rounded-lg border border-gray-100">
          ...
          <div className="space-y-6 flex flex-col h-full">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                {offer.destinations.map((destination, index) => (
                  <div
                    key={index}
                    className="flex items-start text-sm text-gray-600 bg-gray-50 p-2 rounded border border-gray-100"
                  >
            ...
            <div className="flex-grow"></div> {/* Spacer to push booking to bottom if content is short */}
            ...
            <div className="bg-gray-50 p-6 rounded-xl border border-gray-200 shadow-sm mt-4">
              ...
              <div className="flex items-center justify-between mb-2">
                ...
                <div className="flex items-center space-x-3 bg-white px-2 py-1 rounded-lg border border-gray-300">
                  <Button
                    variant="ghost"
                    size="icon"
              ...
              {/* Dynamic Info Text */}
              <div className="mb-4 h-5 flex justify-end">
                {pricingType === "tiered" && (
              ...
              <div className="flex justify-between items-end border-t border-gray-200 pt-4 mb-4">
                <div className="text-sm text-gray-500 font-medium">Total Package Price</div>
              ...
              >
                <Button
                  className="w-full bg-red-600 hover:bg-red-700 text-white font-bold py-3 text-lg rounded-lg shadow-md hover:shadow-lg transition-all"
                  onClick={onClose}
                >
                  Book Now
                </Button>
